    ...
    float height)
{
    ...
    {
        //Bottom Trapezoid
        VertexFormat(corner, bottomColor), // left bottom point
        VertexFormat(corner + glm::vec3(length, 0, 0), bottomColor), //right bottom point
        VertexFormat(corner + glm::vec3(length + length / 2, height, 0) , bottomColor), // right up point
        VertexFormat(corner + glm::vec3(-length/2, height, 0), bottomColor), // left up point

        //Up trapezoid
        VertexFormat(corner + glm::vec3(-length, height, 0), upColor), //left bottom point
        VertexFormat(corner + glm::vec3(2 * length, height, 0), upColor), //right bottom point
        VertexFormat(corner + glm::vec3(length + length * 2 / 3, upHeight, 0), upColor), // right up point
        VertexFormat(corner + glm::vec3(- length * 2 / 3, upHeight, 0), upColor), // left up point
    };
    ...
    vertices.push_back(VertexFormat(corner + glm::vec3(centerSemicercX, centerSemicercY, 0), upColor)); // this is the center of the circle
    int indexCenter = 8;
    ...
    for (int i = 0; i <= numberOfPoints; i++) {
        ...
        vertices.push_back(VertexFormat(corner + glm::vec3(x + centerSemicercX, y + centerSemicercY, 0), upColor));
        if(i == 0) {
